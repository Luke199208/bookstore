    ...
    <table align="center" border="1" cellpadding="0" cellspacing="0">
		...
		<c:forEach items="${sessionScope.categorys}" var="category">
			<tr bordercolor="rgb(78,78,78)">
				...
				<td>
					<a href="<c:url value='/adminjsps/admin/category/mod.jsp?cid=${category.cid}&cname=${category.cname}'/>">修改</a> |
					<a href="<c:url value='/adminjsps/admin/category/del.jsp?cid=${category.cid}&cname=${category.cname}'/>">删除</a>
				</td>
			</tr>
		</c:forEach>
    </table>
